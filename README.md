...
[![Visitors](https://visitor-badge.laobi.icu/badge?page_id=nxZhai.Awesome-AI-generated-Image-Detection&left_color=green&right_color=red)]()
[![GitHub Stars](https://img.shields.io/github/stars/nxZhai/Awesome-AI-generated-Image-Detection?style=social)]()
...
+ [Towards Generalizable Detector for Generated Image]() (Qianshu Cai et al., NeurIPS 2025) [:octocat:](https://github.com/dav-joy-thon/DEnD-Detection)
...
+ [CatAID: Category-Guided AI-Generated Image Detection via Vision-Language Model Adaptation](https://openaccess.thecvf.com/content/ICCV2025W/APAI/html/Cai_CatAID_Category-Guided_AI-Generated_Image_Detection_via_Vision-Language_Model_Adaptation_ICCVW_2025_paper.html) (Yu Cai et al., ICCV Workshop 2025)
...
+ [LATTE: Latent Trajectory Embedding for Diffusion-Generated Image Detection](https://openreview.net/forum?id=spq2xAdg4Z)

+ [Taming the Forensic Singularity: A Regularized Hyperbolic Framework for Generalizable AI-Generated Image Detection](https://openreview.net/forum?id=dW2m8XVgp4)

+ [Redefining Generalization in Visual Domains: A Two-Axis Framework for Fake Image Detection with FusionDetect](https://openreview.net/forum?id=FmPSLMJuOu)

+ [Training-free AI-generated Image Detection via Spectral Artifacts](https://openreview.net/forum?id=G9Oj0dMQIJ)

+ [RAID: Towards Robust AI-Generated Image Detection with Bit Reversed Images](https://openreview.net/forum?id=r402yIwWGQ)

+ [Generalization through Discrepancy: Leveraging Distributional Fitting Gaps for AI-Generated Image Detection](https://openreview.net/forum?id=vzUixzPIHS)

+ [No Pixel Left Behind: A Detail-Preserving Architecture for Robust High-Resolution AI-Generated Image Detection](https://openreview.net/forum?id=9QQ3Kc2hj6)

+ [All Patches Matter, More Patches Better: Enhance AI-Generated Image Detection via Panoptic Patch Learning](https://openreview.net/forum?id=ob7PJs8kPU)

+ [FakeXplain: AI-Generated Images Detection via Human-Aligned Grounded Reasoning](https://openreview.net/forum?id=UcpTOa8OnG)

+ [Seeing Before Reasoning: A Unified Framework for Generalizable and Explainable Fake Image Detection](https://openreview.net/forum?id=Tp70ig4iKN)

+ [Semantic Visual Anomaly Detection and Reasoning in AI-Generated Images](https://openreview.net/forum?id=0iN4UKZwgn)

+ [Triggering Generative Collapse: A Contrastive Inversion Framework for AI-Generated Image Detection](https://openreview.net/forum?id=hvO8d1KxZp)

+ [Intermediate Representations are Strong Training-Free AI-Generated Image Detectors](https://openreview.net/forum?id=NfM92qRuew)

+ [AIGID-RFT: Reinforcement Fine-Tuning Multimodal LLMs for AI-Generated Image Detection](https://openreview.net/forum?id=5WJzbZZeh1)

+ [Unveiling Perceptual Artifacts: A Fine-Grained Benchmark for Interpretable AI-Generated Image Detection](https://openreview.net/forum?id=Tk8ujiOgHM)

+ [SARE: Semantic-Aware Reconstruction Error for Generalizable AI-Generated Image Detection](https://openreview.net/forum?id=RFp9s01xpT)

+ [OmniDFA: A Unified Framework for Open Set Synthesis Image Detection and Few-Shot Attribution](https://openreview.net/forum?id=D7oD66lrbv)

+ [Zoom-In to Sort AI-Generated Images Out](https://openreview.net/forum?id=XknlDPufux)

+ [DiffSeg30k: A Multi-Turn Diffusion Editing Benchmark for Localized AIGC Detection](https://openreview.net/forum?id=wxoM2ky86C)

+ [NeXT-IMDL: Build Benchmark for NeXT-Generation Image Manipulation Detection & Localization](https://openreview.net/forum?id=J0c9gLAfjg)

+ [Exploring Specular Reflection Inconsistency for Generalizable Face Forgery Detection](https://openreview.net/forum?id=KwXkLYmZvR)

+ [A Rich Knowledge Space for Scalable Deepfake Detection](https://openreview.net/forum?id=hNd5L7WnjC)

+ [DeFake: Data-Efficient Adaptation for Generalized Deepfake Detection](https://openreview.net/forum?id=1tYymCWmG5)

+ [Adaptive Gray: Reducing Color Dependency to Improve Generalization in Deepfake Detection](https://openreview.net/forum?id=rrJMJI1k0q)

+ [Synthetic Image Detection via Curvature of Diffusion Probability Flows](https://openreview.net/forum?id=BK5iPNVUdl)

+ [Scaling Laws for Deepfake Detection](https://openreview.net/forum?id=HOGZJfArym)
